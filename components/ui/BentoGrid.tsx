  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`absolute right-0 -bottom-5 ${id === 5 && 'w-full opactiy-80'}`}
        >
          {spareImg && (
            <img
              src={spareImg}
        ...
        >
          <div
            className="font-sans font-extraLight text-[#c1c2d3] text-neutral-600 text-sm md:text-xs lg:text-base z-10"
          >
            {description}
          </div>
